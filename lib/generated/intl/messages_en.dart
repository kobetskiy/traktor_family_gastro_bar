...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "emailNotification" : MessageLookupByLibrary.simpleMessage("Email notification"),
    "emailWasSentSuccessfully" : MessageLookupByLibrary.simpleMessage("Email was sent successfully"),
    ...
    "experienceUniqueDishes" : MessageLookupByLibrary.simpleMessage("Experience unique dishes prepared with love by our chefs. From traditional cuisine to gourmet gastronomic delights."),
    "faq" : MessageLookupByLibrary.simpleMessage("FAQ"),
    "fastDeliveryToYourHome" : MessageLookupByLibrary.simpleMessage("Fast delivery to your home"),
    "favorites" : MessageLookupByLibrary.simpleMessage("Favorites"),
    "foundAnError" : MessageLookupByLibrary.simpleMessage("Found an error?"),
    "frequentlyAskedQuestion" : MessageLookupByLibrary.simpleMessage("Frequently asked question"),
    "from10amTo9pmFreeInUkraine" : MessageLookupByLibrary.simpleMessage("From 10am to 9pm free in Ukraine"),
    "general" : MessageLookupByLibrary.simpleMessage("General"),
    "goBack" : MessageLookupByLibrary.simpleMessage("Go back"),
    "gramsSymbol" : MessageLookupByLibrary.simpleMessage("g"),
    "haveAQuestionContactUs" : MessageLookupByLibrary.simpleMessage("Have a question? Contact us!"),
    "hookah" : MessageLookupByLibrary.simpleMessage("Hookah"),
    "howDoesDeliveryWork" : MessageLookupByLibrary.simpleMessage("How does delivery work?"),
    "howDoesDeliveryWorkContent" : MessageLookupByLibrary.simpleMessage("Delivery of orders is carried out exclusively by the taxi services of the city of Kharkiv, according to the service tariffs. The minimum order amount for delivery is 300 UAH.\\n\\nFor orders from 500 UAH within 7 km from the restaurant, the delivery of orders is FREE!\\n\\nIn the case of orders, the distance of which is more than 7 km from In such cases, the customer pays the delivery cost of UAH 100. For example, the cost of the glass delivery is UAH 100. In this case, the restaurant pays UAH 150. customer.\\n\\nOrders from UAH 3,000 are delivered in Kharkov for FREE! Estimated preparation time from 15 to 40 minutes depending on the load of the kitchen.\\n\\nDelivery time depends on the speed of delivery by the taxi service and the speed of delivery by the driver.\\n \\nThe customer receives all orders at the entrance of his house. There is no delivery to the door!"),
    "howToPlaceAnOrder" : MessageLookupByLibrary.simpleMessage("How to place an order?"),
    "howToPlaceAnOrderContent" : MessageLookupByLibrary.simpleMessage("Orders can be made online in the Traktor Family Gastro Bar application or by calling 073-133-61-87 / 093-676-76-46.\\n\\nPayment for orders is made online in the Traktor Family Gastro Bar application or by card transfer to the restaurant\'s account. \\n\\nOrders are accepted from Monday to Sunday from 11:00 a.m. to 8:45 p.m."),
    "howToReturnTheProduct" : MessageLookupByLibrary.simpleMessage("How to return the product?"),
    "howToReturnTheProductContent" : MessageLookupByLibrary.simpleMessage("Rejection of the product is possible at the time of receipt and if it is of inadequate quality. The transferred funds are returned to your bank account within 5 - 30 working days (the term depends on the Bank that issued your bank card)."),
    ...
    "thankYouForYourFeedback" : MessageLookupByLibrary.simpleMessage("Thank you for your feedback"),
    ...
    "wantToLogOut" : MessageLookupByLibrary.simpleMessage("Want to log out?"),
    "weAreAlreadyFixingThisBugPleaseTryAgainLater" : MessageLookupByLibrary.simpleMessage("We are already fixing this bug, please try again later"),
